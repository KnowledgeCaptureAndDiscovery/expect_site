...
public class MainWindow extends JFrame implements ActionListener 
{
    ...
    JMenuItem clipItem, histItem, loadItem, caporgItem,metanalItem,metseekItem,metclipItem,metpropItem;
    ...
    public MainWindow() 
    {
    	super("Expect Main Interaction Window");
    	//lc = new LispSocketAPI(hostName, port);
    	es = new ExpectSocketAPI();
	//new UpdateChildrenThread(this).start();
	makeMainWindow();
    }

  public MainWindow(ExpectSocketAPI passed_esa) {
    super("Expect Main Interaction Window");
    es = passed_esa;
    //new UpdateChildrenThread(this).start();
...
public class GoalThread extends Thread {
    ...
    maker = createMakerFrame(goalPanel, "Describe what I can run");
    
    maker.setBounds (400,2, 600, 150); 
    ...
    maker = createMakerFrame(listPanel, "Methods");
    toggleFlg = true;
    }
    else
    {
    ...
    maker = createMakerFrame(englistPanel, "Methods");
    toggleFlg = false;
    }
   ...
   public void makeMainWindow() {
	 ...
	 metanalItem = new JMenuItem("Method Sub-Method Analyzer");
	 metanalItem.addActionListener(this);
	 metseekItem = new JMenuItem("Method Seeker");
	 metseekItem.addActionListener(this);
	 //metclipItem = new JMenuItem("Clipboard For Methods");
	 //metclipItem.addActionListener(this);
	 metpropItem = new JMenuItem("Method Proposer");
	 metpropItem.addActionListener(this);
	 ...
	 JMenu tp2 = new JMenu("");
	 JMenu tp3 = new JMenu("");
	 JMenu uname = new JMenu("Welcome to Expect    User: "+user+"   Connected to Expect Server");
	 ...
	 advMenu.add(metanalItem);
	 advMenu.add(metseekItem);
	 //advMenu.add(metclipItem);
	 advMenu.add(metpropItem);
    ...
    lc = new JDesktopPane();
    lc.setOpaque(false);
     JLabel l3 = new JLabel("Please wait:Loading ... ");
     l3.setFont(f14);
     l3.setBounds(50,0,650,30);
	 l3.setForeground(Color.blue);
	  contentPane.add(l3);   
    /*if(toggleFlg==false)
    {
  ...
  public void showMetAnal()
  {
  	
  	GRPanel tpanel = new GRPanel("method-relation",es, null, null);
    JFrame frame = new JFrame("Method Sub-Method Analyzer");
     frame.addWindowListener(new WindowAdapter() {
        public void windowClosing(WindowEvent e) {
                  //System.exit(0);
        }
  ...
  public void showMetProp()
  {		
  	JFrame frame = new JFrame("Method Proposer");
      //ExpectSocketAPI es = new ExpectSocketAPI();
      frame.addWindowListener(new WindowAdapter() {
        public void windowClosing(WindowEvent e) {
                  //System.exit(0);
  ...
  /*public void showMethodEditor()
  {
   ...
   public void actionPerformed(ActionEvent e) {
     ...
     else if(src==metpropItem)
     {
     	showMetProp();
     }
     else if(src==metanalItem)
     {
     	showMetAnal();
     }
     else if(src==metseekItem)		
     {
     	showMetSeek();
     }	
