...
public class exTabbedPanel extends JPanel {  
  ...
  public exTabbedPanel (ExpectSocketAPI server, ExpectWindowPanel rootPanel,
...
// commented by mukta
  ...
  //  ugPanel = new PSundefinedGoalsPanel(es, rootPanel, this, wizard, useNLEditor);
    ...
    tabbedPane.addTab("Method Relation In Execution Tree", null, 
		      new exTreePanel(es, this, rootPanel));
  ...
  public void reloadPSTabs () {
    ...
    tabbedPane.addTab("Method Relation in problem solving", null, 
		  new exTreePanel(es, this, thePanel));
    tabbedPane.setSelectedIndex(1);
    add("Center",tabbedPane);
    reloadButton = new JButton("reload");
    reloadButton.addActionListener (new reloadListener());
  ...
  public static void main(String[] args) {
    ...
    frame.getContentPane().add("Center", new exTabbedPanel(es, null,null,true));
