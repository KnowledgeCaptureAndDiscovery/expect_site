...
public class ExecPanel extends JPanel {
  ...
  exTabbedPanel thePSPanel= null;
  ExpectWindowPanel mainPanel;
  String methodName;
  
  public ExecPanel(String Stype, ExpectSocketAPI theServer,
  ...
  public ExecPanel(String Stype, String subRoot, ExpectSocketAPI theServer,
		 exTabbedPanel thePanel,
		 ExpectWindowPanel rootPanel) {
    newRootName = subRoot;
    if (null != thePanel) gPanel = thePanel.getUGPanel();
  ...
  private void buildTree() {
    ...
    if (type.equals("method-relation")) {
      xmlInput = es.getEXEMethodRelTree();
    }
  ...
  private void createButtons() {
    ...
    if (null != thePSPanel) {
      editButton = new JButton("Modify Method");
  ...
  public static void main(String[] args) { 
    ...
    ExecPanel tpanel = new ExecPanel("method-relation",es, null, null);
