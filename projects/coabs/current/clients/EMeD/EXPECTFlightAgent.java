...
public class EXPECTFlightAgent extends JFrame implements ActionListener
{
	...
	/*JLabel infoLabel = new JLabel ("Flight Monitoring System");
	...
	infoPanel.add(infoLabel);*/
	 ...
	 relation.setBounds(300,100,150,25);
      ...
      status.setBounds(300,200,150,25);
	...
	public void actionPerformed(ActionEvent e)
	{
      ...
      JLabel number3 = new JLabel ("Departure City");
	  ...
	  JLabel number4 = new JLabel ("Arrival City");
	  ...
	  JLabel number5 = new JLabel ("Arrival Date");
	  ...
	  JLabel number6 = new JLabel ("User");
	  ...
	  JButton rsltbtn = new JButton("Click here for results");
	  rsltbtn.setBounds(410,170,250,25);
      rsltbtn.setForeground(Color.white);
      rsltbtn.setBackground(((Color.blue).darker().darker()));
      rsltbtn.setMnemonic('R');
	  
	  JButton histbtn = new JButton("Show All Airfares");
	  histbtn.setBounds(410,250,250,25);
      ...
      areaScrollPane.setBounds(200,400,300,300);
	...
	public void actionPerformed(ActionEvent e)
	{
      ...
      statusPanel.setBounds(100,100,800,800);
      statusPanel.setBackground(Color.lightGray);
        
      statusPanel.setBorder(BorderFactory.createCompoundBorder(
      BorderFactory.createLineBorder(Color.black,4),
      BorderFactory.createEmptyBorder(5,5,5,5)));
      JLabel addnum = new JLabel(" Flight Status");
      addnum.setBounds(300,5,300,30);
	  addnum.setFont(f16); 
	  addnum.setForeground((Color.blue).darker());
	  ...
	  JButton histbtn = new JButton("Show previous status of flights");
	  histbtn.setBounds(410,250,250,25);
      histbtn.setForeground(Color.white);
      histbtn.setBackground(((Color.blue).darker().darker()));
      histbtn.setMnemonic('H');
	...
	public void actionPerformed(ActionEvent e)
	{
	  ...
	  JButton histbtn = new JButton("Show All Previous Schedules");
	  histbtn.setBounds(410,250,250,25);
      histbtn.setForeground(Color.white);
      histbtn.setBackground(((Color.blue).darker().darker()));
      histbtn.setMnemonic('H');
      ...
      public void actionPerformed(ActionEvent e)
      {
      	...
      	try
      	{
      		...
      		BufferedReader rd = new BufferedReader(fileIn);
      		String line;
      		JTextArea schedArea1 = new JTextArea(300,300);
	...
	{
		EXPECTFlightAgent sng = new EXPECTFlightAgent();
