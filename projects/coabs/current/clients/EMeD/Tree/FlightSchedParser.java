...
public class FlightSchedParser extends renderer {

  String xmlData;
  Vector listOfGoals;
  //String listOfGoals="";
  int i=0;
  public FlightSchedParser() {
    this("");
  }

  public FlightSchedParser(String goalList) {
  ...
  listOfGoals = new Vector();
    ...
    if(goalList==null) {
      ...
      int result = runFromNamedParser(new InputSource("flightsched.xml"), "com.ibm.xml.parser.SAXDriver");
