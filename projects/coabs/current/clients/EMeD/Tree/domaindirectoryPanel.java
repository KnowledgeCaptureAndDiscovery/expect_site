...
public class domaindirectoryPanel extends JPanel {
  ExpectSocketAPI es;
  expandableTree tree;
  ...
  private domaindirectoryPanel mp;
  String origString;
  public domaindirectoryPanel(ExpectSocketAPI theServer,
		      CritiqueWizard w,
		      boolean useNL) {
    es = theServer;
    mp = this;
    ...
    String xmlInput = es.getDomainDir(user);
    ...
    buttons = new JPanel();
    loadButton = new JButton ("Load Domain");
