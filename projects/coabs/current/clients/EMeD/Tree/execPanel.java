...
public class execPanel extends JPanel {
  ...
  String source;
  private execPanel mp;
  
  public execPanel(ExpectSocketAPI theServer,
		      CritiqueWizard w,
		      boolean useNL) {
    es = theServer;
    mp = this;
    ...
    String xmlInput = es.getEXEMethodRelTree();
  ...
  */
  ...
  public static void main(String[] args) {
      ...
      frame.getContentPane().add("Center", new execPanel(es, null, false));
