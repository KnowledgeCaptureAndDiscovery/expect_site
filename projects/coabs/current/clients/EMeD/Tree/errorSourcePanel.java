...
public class errorSourcePanel extends JPanel {
  ExpectSocketAPI es;
  expandableTree tree;
  ...
  String source;
  private errorSourcePanel mp;
  public errorSourcePanel(ExpectSocketAPI theServer,
		      CritiqueWizard w,
		      boolean useNL) {
    es = theServer;
    mp = this;
    ...
    String xmlInput = es.getErrorMessagesBySource();
  ...
  */
  ...
  public static void main(String[] args) {
      ...
      frame.getContentPane().add("Center", new errorSourcePanel(es, null, false));
