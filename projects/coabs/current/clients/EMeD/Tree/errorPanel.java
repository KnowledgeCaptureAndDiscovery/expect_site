...
public class errorPanel extends JPanel {
  ...
  String source;
  private errorPanel mp;
  public errorPanel(ExpectSocketAPI theServer,
		      CritiqueWizard w,
		      boolean useNL) {
    es = theServer;
    mp = this;
    ...
    */
    ...
    subtabbedPane.addTab("Organize errors by Type",new messagePanel(es,null,false));
    subtabbedPane.addTab("Organize errors by Source",new errorSourcePanel(es,null,false));
