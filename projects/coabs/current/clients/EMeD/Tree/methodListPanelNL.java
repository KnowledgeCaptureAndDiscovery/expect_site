...
public class methodListPanelNL extends JPanel {
  ...
  public methodListPanelNL(ExpectSocketAPI theServer, 
  ...
  public static void main(String[] args) {
      ...
      frame.getContentPane().add("Center", new methodListPanelNL(es,null,"normal"));
