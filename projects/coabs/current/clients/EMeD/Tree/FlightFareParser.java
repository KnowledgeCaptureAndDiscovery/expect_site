...
public class FlightFareParser extends renderer {

  String xmlData;
  Vector listOfGoals;
  //String listOfGoals="";
  int i=0;
  public FlightFareParser() {
    this("");
  }

  public FlightFareParser(String goalList) {
  ...
  listOfGoals = new Vector();
    ...
    if(goalList==null) {
      ...
      int result = runFromNamedParser(new InputSource("flightlog.xml"), "com.ibm.xml.parser.SAXDriver");
