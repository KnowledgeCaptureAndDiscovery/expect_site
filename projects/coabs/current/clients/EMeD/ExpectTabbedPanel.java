...
public class ExpectTabbedPanel extends JPanel {  
 ...
 /*tabbedPane.addTab("Execution Tree", 
		      new EXEPanel(es,exTabbedPanel,null,false));*/
    //o.println("added MR tree in PS");
// commented by mukta
...
// end commented by mukta
   ...
   tabbedPane.addTab("Ontology Browser",new HtmlPanel(es,"file:///C:/Mukta/current/clients/EMeD/","TOP-DOMAIN-CONCEPT.concept"));
    /*tabbedPane.addTab("Ontology Browser",
		      new HtmlPanel(es,"http://www.yahoo.com",
				    ""));*/
    ...
    tabbedPane.addTab("Global Error Detector", 
		      new errorPanel(es,null,false));
    o.println("added Global Error Detector");
    tabbedPane.addTab("Execution Tree", 
		      new exTabbedPanel(es,thePanel,null,false));
    o.println("added Global Error Detector");
  ...
  public void reload () {
    ...
    tabbedPane.addTab("Ontology Browser",null,
          new HtmlPanel(es,"file:///C:/Mukta/current/clients/EMeD/","TOP-DOMAIN-CONCEPT.concept"));
	...
	tabbedPane.addTab("Execution Tree", null,
    	  new exTabbedPanel(es,thePanel,null,false));
	/*tabbedPane.addTab("Execution Tree", null, 
		      new execPanel(es, null, false));*/	      
    //tabbedPane.addTab("Problem Solving Details", null, new psDescribePanel(es));
    tabbedPane.addTab("Method Seeker", null, new Tree.searchPanel(es,null,thePanel));
