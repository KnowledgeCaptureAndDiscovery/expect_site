...
public class RKF extends JFrame {
    ...
    private RKF self = null;

    public RKF() {

      super("Acquisition of Procedural Knowledge");
	...
	public void actionPerformed(ActionEvent e) {
	  JFrame f = new JFrame("Problem solving tree");
	...
	public void actionPerformed(ActionEvent e) {
	  ...
	  if (lc.connected() == true) {
        ...
        JButton instanceBut = new JButton("Instance Editor");
	...
	public void actionPerformed(MouseEvent e) {
	  ...
	  if (item.name != null) {   // clicked on a critique
	    ...
	    // Need some other basic behaviour now
