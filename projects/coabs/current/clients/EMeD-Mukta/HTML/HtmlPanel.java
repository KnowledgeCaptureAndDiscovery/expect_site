...
public class HtmlPanel extends JPanel implements HyperlinkListener{
  ...
  public static void main(String[] args)  { 
    ...
    //commented by Mukta
    //JPanel tpanel = new HtmlPanel(es,"file:/nfs/v2/expect/current/clients/EMeD/HTML/","TOP-DOMAIN-CONCEPT.concept");
    //added by Mukta
      JPanel tpanel = new HtmlPanel(es,"file://C:\\Mukta\\current\\clients\\EMeD\\","TOP-DOMAIN-CONCEPT.concept");
    
    
    //JPanel tpanel = new HtmlPanel(es,"file:/nfs/v2/jihie/expect/EMeD/Client2/HTML/","COA.concept");
