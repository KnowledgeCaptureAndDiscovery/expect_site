...
public class ExpectLispAPI extends ExpectSocketAPI {
  ...
  static String defaultPort="9999";
  ...
  **************************************************************/
  ...
  public String getTopGoal (String goal) {
  ...
  public String getVarForType (String desc, String type)  {
    return evaluateLispCommand("(get-edit-vars \""+desc+"\" \""+type+"\")",
			defaultPackage);
  }
  ...
  **************************************************************/
  ...
  public static void main(String[] args) {
   ExpectLispAPI api = new ExpectLispAPI();
