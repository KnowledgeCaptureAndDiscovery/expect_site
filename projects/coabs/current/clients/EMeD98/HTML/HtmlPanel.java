...
public class HtmlPanel extends JPanel implements HyperlinkListener{
  ...
  JButton findButton;
  String baseLoc;
    public HtmlPanel(ExpectServer theServer, String baseURL, String initURL) {
      es = theServer;
  ...
  public static void main(String[] args) { 
    ...
    JPanel tpanel = new HtmlPanel(es,"file:///C:/bcbl-exp/client-source/HTML/","COMBAT-POWER.concept");
    //JPanel tpanel = new HtmlPanel(es,"file:/nfs/v2/jihie/expect/EMeD/Client/HTML/","COA.concept");
    //JPanel tpanel = new HtmlPanel(es,"file:/nfs/v2/jihie/expect/EMeD/Client/HTML/","");
