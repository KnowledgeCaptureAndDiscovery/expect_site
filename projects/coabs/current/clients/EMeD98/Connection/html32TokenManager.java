...
public static final int[] jjnewLexState = {
   ...
   4, 0, 3, -1, -1, -1, -1, -1, 2, -1, -1, 2, 
};
static final long[] jjtoToken = {
   0xfffffffffffffff9L, 0xa33ffL, 
};
...
public html32TokenManager(ASCII_CharStream stream)
{
   if (ASCII_CharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public html32TokenManager(ASCII_CharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
