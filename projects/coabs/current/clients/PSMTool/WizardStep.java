...
public class WizardStep extends WizardLine {
    ...
    public void performStep() {
	  ...
	  regenAndRunCritiquer();
        } else if (command.equals("kill_critiquer") == true) {
	/*if (wizard.parent.interdepAnal != null) {
	      wizard.parent.interdepAnal.dispose();
	  }
	  wizard.parent.dispose();
	  */
        }
    }
    ...
    public void regenAndRunCritiquer() {
        ...
        //commented by mukta
        wizard.lc.sendLispCommand("(expect::regen-critiquer)");
