...
public class ActiveText extends JTextPane implements MouseInputListener {
  ...
  public Style normalStyle, highlightStyle, selectedStyle, errorStyle,
    matchHighlightStyle;
  ...
  public void selectAround(int place) {
    ...
    if (selected != null && layedPlace != null && 
      ...
      if (selected.normalStyle != null) {
        doc.setCharacterAttributes(selected.start,
			     selected.length,
			     selected.normalStyle, true);
      } else {
        doc.setCharacterAttributes(selected.start,
			     selected.length,
			     normalStyle, true);
