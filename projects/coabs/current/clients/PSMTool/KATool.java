...
public class KATool extends JFrame {
  ...
  public KATool(LispSocketAPI passed_lc, CritiqueView passed_parent,
  ...
  public KATool(LispSocketAPI passed_lc, CritiqueView passed_parent,
	      String passedCritiqueName, NameFieldPanel nfp) {
    super("Acquisition Wizard");
    parent = passed_parent;
    lc = passed_lc;
    es = new ExpectSocketAPI(lc);
    ...
    nameField = nfp;
    buildInitialWindow();
    System.out.println("NameFieldPanel is " + nameField);
  }

  public void buildInitialWindow() {
    self = this;
    setFont(new Font("SansSerif", Font.PLAIN, 12));
    // Stick with the border layout.
    ...
    wizard = new CritiqueWizard(lc, parent, nameField, critiqueName);
    wizard.setPreferredSize(new Dimension(750,700));
    ...
    cwScrollPane.setMinimumSize(new Dimension(750,700));
    mainPanel.add(cwScrollPane, BorderLayout.CENTER);
    ...
    if (allOneWindow == true) {
      ...
      interdepAnal = new JFrame("Interdependency Analyzer");
      interdepAnal.getContentPane().add(lp);
      interdepAnal.setSize(612,632);
      //interdepAnal.getContentPane().add(right);
      //interdepAnal.pack();
      interdepAnal.setVisible(true);
    }
  ...
  public void updateTree() {
    if (treePanel == null) {
      System.out.println("treepanel was null\n");
      treePanel = new PSTree.psTabbedPanel(es, null, wizard, true);
      ...
      System.out.println("treepanel was not null\n");
      treePanel.reloadPSTabs();
    }
  }
