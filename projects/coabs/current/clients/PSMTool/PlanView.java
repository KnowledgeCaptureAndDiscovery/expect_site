...
public class PlanView extends JPanel {
  ...
  public NameFieldPanel fields[], edit=null, details=null,selectedField = null;
...
/*    JButton editBut = new JButton("edit");
	...
	detailsBut.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        details.toggleSelected();
        details.showDetails();
      }}); */
