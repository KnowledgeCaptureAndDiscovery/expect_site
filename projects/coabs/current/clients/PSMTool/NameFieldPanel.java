...
public class NameFieldPanel extends JPanel {
  ...
  public JLabel labelField = null, valueField = null;
  ...
  public void makeNFP(String pname) {
    ...
    labelField = new JLabel(longName);
    Font f14 = new Font("TimesNewRoman",Font.BOLD,14);
    labelField.setFont(f14);
    
    labelField.setForeground(((Color.black).darker().darker().darker().darker()));
    //labelField.setForeground(lightred);
    ...
    Font f12 = new Font("TimesNewRoman",Font.BOLD,14);
    valueField.setFont(f12);
    valueField.setForeground(((Color.blue).darker().darker().darker()));
