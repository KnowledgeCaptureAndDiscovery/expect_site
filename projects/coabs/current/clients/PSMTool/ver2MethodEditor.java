  ...
  public MethodEditor(String passed_methodName, LispSocketAPI passed_lc) {
	...
	public void actionPerformed(ActionEvent e) {
	  ...
	  setCursor(oldCursor);
        ...
        cancelBut.setBounds(120,10,80,25);
	  ...
	  public void actionPerformed(ActionEvent e) {
        ...
        applyBut.setBounds(220,10,80,25);
	...
	public void actionPerformed(ActionEvent e) {
	  new MethodApplier(methodName, lc);
        ...
        capScrollPane.setPreferredSize(new Dimension(500,150));
...
+ oldObj.name + " " + newObj.name + " nil))");
	  ...
	  public void actionPerformed(ActionEvent e) {
        ...
        butPane.add(nextBut);
        butPane.setPreferredSize(new Dimension(500, 100));
        butPane.setMaximumSize(new Dimension(500, 100));
