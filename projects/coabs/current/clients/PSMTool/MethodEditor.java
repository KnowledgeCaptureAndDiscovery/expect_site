  ...
  public MethodEditor(String passed_methodName, LispSocketAPI passed_lc) {
	...
	public void actionPerformed(ActionEvent e) {
	  new MethodApplier(methodName, lc);
        ...
        Color nonEditColor= new Color(204,204,204);
        capArea.setEditable(false);
        
        capArea.setBackground(nonEditColor);
        ...
        newField.setBounds(80,60,300,25);
        newField.setForeground(Color.green);
        oldTextPane.add(newField);
        
        JButton updateBut = new JButton("Replace");
        updateBut.setBounds(400,40,80,25);
...
+ oldObj.name + " " + newObj.name + " nil))");
	  ...
	  public void actionPerformed(ActionEvent e) {
        ...
        JButton clearBut = new JButton("Cancel Replace");
        clearBut.setBounds(200,40,140,25);
	  ...
	  public void actionPerformed(ActionEvent e) {
        ...
        searchField.setBounds(480,40,150,25);
	  ...
	  public void keyTyped(KeyEvent e) {
        ...
        searchBut.setBounds(360,40,100,25); 
	  ...
	  public void actionPerformed(ActionEvent e) {
        ...
        nextBut.setBounds(640,40,80,25);
	  ...
	  public void actionPerformed(ActionEvent e) {
        ...
        butPane.add(nextBut);
        butPane.setPreferredSize(new Dimension(740, 80));
        butPane.setMaximumSize(new Dimension(740, 80));
