...
var gDocTable = new Array(
   ...
   new hrefList("slide0475.htm", 1, 2),
   new hrefList("slide0448.htm", 1, 3),
   new hrefList("slide0491.htm", 1, 4),
   new hrefList("slide0496.htm", 1, 5),
   new hrefList("slide0493.htm", 1, 6),
   new hrefList("slide0504.htm", 1, 7),
   new hrefList("slide0497.htm", 1, 8),
   new hrefList("slide0498.htm", 1, 9),
   new hrefList("slide0499.htm", 1, 10),
   new hrefList("slide0500.htm", 1, 11),
   new hrefList("slide0501.htm", 1, 12),
   new hrefList("slide0502.htm", 1, 13),
   new hrefList("slide0503.htm", 1, 14)
);
