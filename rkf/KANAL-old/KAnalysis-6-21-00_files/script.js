...
var gDocTable = new Array(
   ...
   new hrefList("slide0049.htm", 1, 2),
   new hrefList("slide0050.htm", 1, 3),
   new hrefList("slide0051.htm", 1, 4),
   new hrefList("slide0052.htm", 1, 5),
   new hrefList("slide0053.htm", 1, 6),
   new hrefList("slide0054.htm", 1, 7),
   new hrefList("slide0055.htm", 1, 8),
   new hrefList("slide0057.htm", 1, 9),
   new hrefList("slide0058.htm", 1, 10),
   new hrefList("slide0059.htm", 1, 11),
   new hrefList("slide0060.htm", 1, 12),
   new hrefList("slide0056.htm", 1, 13)
);
