...
var gDocTable = new Array(
   new hrefList("slide0013.htm", 1, 1),
   new hrefList("slide0086.htm", 1, 2),
   new hrefList("slide0033.htm", 1, 3),
   new hrefList("slide0087.htm", 1, 4),
   new hrefList("slide0088.htm", 1, 5),
   new hrefList("slide0089.htm", 1, 6),
   new hrefList("slide0090.htm", 1, 7),
   new hrefList("slide0091.htm", 1, 8),
   new hrefList("slide0093.htm", 1, 9),
   new hrefList("slide0101.htm", 1, 10),
   new hrefList("slide0095.htm", 1, 11),
   new hrefList("slide0096.htm", 1, 12),
   new hrefList("slide0098.htm", 1, 13),
   new hrefList("slide0100.htm", 1, 14)
);
