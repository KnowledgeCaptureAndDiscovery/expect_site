...
var gDocTable = new Array(
   ...
   new hrefList("slide0041.htm", 1, 2),
   new hrefList("slide0028.htm", 1, 3),
   new hrefList("slide0043.htm", 1, 4),
   new hrefList("slide0038.htm", 1, 5),
   new hrefList("slide0046.htm", 1, 6),
   new hrefList("slide0029.htm", 1, 7),
   new hrefList("slide0030.htm", 1, 8),
   new hrefList("slide0026.htm", 1, 9),
   new hrefList("slide0036.htm", 1, 10),
   new hrefList("slide0040.htm", 1, 11)
);
