...
var gDocTable = new Array(
   new hrefList("slide0005.htm", 1, 1),
   new hrefList("slide0038.htm", 1, 2),
   new hrefList("slide0039.htm", 1, 3),
   new hrefList("slide0049.htm", 1, 4),
   new hrefList("slide0042.htm", 1, 5),
   new hrefList("slide0040.htm", 1, 6),
   new hrefList("slide0048.htm", 1, 7),
   new hrefList("slide0051.htm", 1, 8),
   new hrefList("slide0050.htm", 1, 9),
   new hrefList("slide0046.htm", 1, 10),
   new hrefList("slide0045.htm", 1, 11)
);
