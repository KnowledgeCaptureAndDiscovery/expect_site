...
var gDocTable = new Array(
   new hrefList("slide0071.htm", 1, 1),
   new hrefList("slide0083.htm", 1, 2),
   new hrefList("slide0093.htm", 1, 3),
   new hrefList("slide0103.htm", 1, 4),
   new hrefList("slide0104.htm", 1, 5),
   new hrefList("slide0080.htm", 1, 6),
   new hrefList("slide0102.htm", 1, 7),
   new hrefList("slide0105.htm", 1, 8),
   new hrefList("slide0072.htm", 1, 9),
   new hrefList("slide0101.htm", 1, 10),
   new hrefList("slide0088.htm", 1, 11),
   new hrefList("slide0111.htm", 1, 12),
   new hrefList("slide0099.htm", 1, 13),
   new hrefList("slide0106.htm", 1, 14),
   new hrefList("slide0108.htm", 1, 15),
   new hrefList("slide0109.htm", 1, 16),
   new hrefList("slide0110.htm", 1, 17)
);
