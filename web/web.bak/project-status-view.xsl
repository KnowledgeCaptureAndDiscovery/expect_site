...
<TR>
  ...
  <TD class='b' valign='top'>
    <H2>Status</H2>
	 ...
	 <p />
    The <xsl:value-of select="project/name"/> project started in <font color='red'>
    <xsl:value-of select="project/funding/startdate"/></font> and is funded through 
    <xsl:value-of select="project/funding/enddate"/>
  </TD>
</TR>
</TABLE>
</BODY>
