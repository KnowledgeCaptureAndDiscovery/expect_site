...
<TR>
  ...
  <TD class='b' valign='top'>
<xsl:value-of select="isdfunds/funding/program"/>.
...
<TR>
  ...
  <TD class='b' valign='top'>
The <A href='http://www.isi.edu/expect/'><b>EXPECT</b></A> Group homepage. <A href='project-links-view.xml'>
<P />
More <b>links</b>
--&gt;</A>
  </TD>
...
<TR>
  ...
  <TD class='b' valign='top'>
The <xsl:value-of select="project/name"/> project started <font color='red'>
<xsl:value-of select="project/funding/startdate"/>
</font> and is ongoing.
<P />
