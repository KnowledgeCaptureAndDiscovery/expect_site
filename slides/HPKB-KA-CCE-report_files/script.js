...
var g_supportsPPTHTML = SupportsPPTHTML(), g_scaleInFrame = false, gId="", g_bgSound="",
...
var gDocTable = new Array(
   ...
   new hrefList("slide0220.htm", 1, 2),
   new hrefList("slide0207.htm", 1, 3),
   new hrefList("slide0210.htm", 1, 4),
   new hrefList("slide0211.htm", 1, 5),
   new hrefList("slide0200.htm", 1, 6),
   new hrefList("slide0209.htm", 1, 7),
   new hrefList("slide0178.htm", 1, 8),
   new hrefList("slide0180.htm", 1, 9),
   new hrefList("slide0181.htm", 1, 10),
   new hrefList("slide0182.htm", 1, 11),
   new hrefList("slide0212.htm", 1, 12),
   new hrefList("slide0183.htm", 1, 13),
   new hrefList("slide0213.htm", 1, 14),
   new hrefList("slide0221.htm", 1, 15),
   new hrefList("slide0188.htm", 1, 16),
   new hrefList("slide0189.htm", 1, 17),
   new hrefList("slide0190.htm", 1, 18),
   new hrefList("slide0191.htm", 1, 19),
   new hrefList("slide0192.htm", 1, 20),
   new hrefList("slide0193.htm", 1, 21),
   new hrefList("slide0194.htm", 1, 22),
   new hrefList("slide0196.htm", 1, 23),
   new hrefList("slide0197.htm", 1, 24),
   new hrefList("slide0204.htm", 1, 25),
   new hrefList("slide0195.htm", 1, 26),
   new hrefList("slide0198.htm", 1, 27),
   new hrefList("slide0199.htm", 1, 28),
   new hrefList("slide0219.htm", 1, 29),
   new hrefList("slide0226.htm", 1, 30),
   new hrefList("slide0227.htm", 1, 31)
);
